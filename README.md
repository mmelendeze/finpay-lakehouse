...
The 'Bundle_20260525' project was generated by using the default-python template.

* `src/`: Python source code for this project.
  * `src/Bundle_20260525/`: Shared Python code that can be used by jobs and pipelines.
...
2. To deploy a development copy of this project, type:
    ...
    `[dev yourname] Bundle_20260525_etl` to your workspace.
...
>>>>>>> fc01910abc5112a691f83ca610a22c28a9a6d062
